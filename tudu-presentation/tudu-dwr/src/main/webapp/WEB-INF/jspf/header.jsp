...
<table width="100%"><tr><td width="152"><a href="http://tudu.sourceforge.net"><img src="${staticCtx}/images/tudu_logo.png" alt="Tudu Lists" width="150" height="30" border="0"/></a></td><td>
  ...
  <tr>
   ...
   <td>
    <% if (request.getRemoteUser() != null) { %>
     <div id="username"><img src="${staticCtx}/images/user_suit.png"/> <%=request.getRemoteUser()%></div>
    <% } %>    
   </td>
  </tr>
  <tr>
