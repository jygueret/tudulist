...
/**
 * TuduListsWebServiceSoapBindingStub.java
 *
 ...
 */
public class TuduListsWebServiceSoapBindingStub extends org.apache.axis.client.Stub implements tudu.web.ws.axis.AxisTuduLists {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setReturnType(new javax.xml.namespace.QName("http://axis.ws.web.tudu", "ArrayOf_tns1_WsTodoList"));
        oper.setReturnClass(tudu.web.ws.bean.WsTodoList[].class);
        oper.setReturnQName(new javax.xml.namespace.QName("", "getAllTodoListsReturn"));
        ...
        oper.setReturnQName(new javax.xml.namespace.QName("", "getTodosByTodoListReturn"));
        oper.setStyle(org.apache.axis.constants.Style.RPC);
        oper.setUse(org.apache.axis.constants.Use.ENCODED);
        _operations[1] = oper;
    ...
    public TuduListsWebServiceSoapBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public TuduListsWebServiceSoapBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    @SuppressWarnings({"unused","unchecked"})
    public TuduListsWebServiceSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            qName = new javax.xml.namespace.QName("http://axis.ws.web.tudu", "ArrayOf_tns1_WsTodoList");
            cachedSerQNames.add(qName);
